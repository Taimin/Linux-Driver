...
static int major = 0;
static struct class *fourthdrv_class = NULL;
static struct device *fourthdrv_dev = NULL;
...
static int fourth_drv_init(void)
{
	...
	fourthdrv_dev = device_create(fourthdrv_class, NULL, MKDEV(major, 0), NULL, "yang");
...
static void fourth_drv_exit(void)
{
	...
	device_unregister(fourthdrv_dev);
